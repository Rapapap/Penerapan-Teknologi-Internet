    ...
    <center>
      <table width="300" border="1">
        ...
        <tr>
          ...
          <td>
            <div align="right">Rp. <?php echo number_format($harga, 0, ",", "."); ?>;</div>
          </td>
        </tr>
        <tr>
          <td align="left">Jumlah Beli</td>
          <td>
            <div align="right"><?php echo number_format($jumlah, 0, ",", "."); ?>;</div>
          </td>
        </tr>
        <tr>
          <td align="left">Sub Total</td>
          <td>
            <div align="right">Rp. <?php echo number_format($subtotal, 0, ",", "."); ?>;</div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div align="right"> <?php echo $ket_status; ?></div>
          </td>
        ...
        <tr>
          ...
          <td>
            <div align="right">Rp. <?php echo number_format($diskon, 0, ",", "."); ?>;</div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div align="right"> Rp. <?php echo number_format($diskon_status, 0, ",", "."); ?>;</div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div align="right"> Rp. <?php echo number_format($total_diskon, 0, ",", "."); ?>;</div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div align="right"> Rp. <?php echo number_format($ongkos_kirim, 0, ",", ".") . " ($kota_kirim)"; ?></div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div align="right">Rp. <?php echo number_format($totalbayar, 0, ",", "."); ?>;</div>
          </td>
        </tr>
      </table>
